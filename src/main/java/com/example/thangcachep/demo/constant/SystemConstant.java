package com.example.thangcachep.demo.constant;
...
public class SystemConstant {
    ...
    public static final String HOME = "/Giaodienchinh-long/trang-chu.html";
    public static final String STAFF_ROLE = "ROLE_STAFF";
    public static final String ADMIN_HOME = "/QLnhanvien-long/index.html";
